// components/OutputPanel/OutputPanelTabs.tsx
'use client';
...
const tabs: { id: TabType; label: string; icon: string; tooltip: string }[] = [
  ...
  { id: 'carbon', label: 'Carbon', icon: '🎨', tooltip: 'Create beautiful code snapshots' },
];

const OutputPanelTabs = memo(function OutputPanelTabs({ activeTab, setActiveTab }: OutputPanelTabsProps) {
  return (
...
OutputPanelTabs.displayName = 'OutputPanelTabs';

export default OutputPanelTabs;