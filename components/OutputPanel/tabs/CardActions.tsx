...
export default function CardActions({
  ...
  // ===== کلیک خارج از منو (فقط روی dropdown) =====
  useEffect(() => {
  ...
  }, [showShareDropdown, toggleDropdown]);

  // ===== جلوگیری از انتشار رویداد کلیک =====
  ...
  return (
    <div className="flex items-center gap-2" onClick={stopPropagation}>
      {/* ===== CopyButton با stopPropagation ===== */}
      <div onClick={(e) => e.stopPropagation()}>
        <CopyButton 
          text={cardPageUrl}
          label="Copy" 
          tooltip="Copy card page link"
          onCopy={() => showToast('✅ Card page link copied!')}
        />
      </div>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {showShareDropdown && (
          <div 
            className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-[#d0d0d8] py-1 z-50"
