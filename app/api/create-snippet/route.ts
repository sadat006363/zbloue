...
export const POST = withCsrfProtection(
  withErrorHandlerAndLog(async (req: NextRequest) => {
    ...
    const legacyFields = [
      ...
      'code_walkthrough', 'what_works_well', 'bugs_and_risky_cases',
      'edge_cases', 'performance_analysis', 'security_analysis',
      'production_readiness', 'recommended_improvements',
      'improved_code', 'suggested_tests', 'scorecard',
      'final_verdict_summary', 'final_verdict_approved',
      'final_verdict_next_steps', 'findings', 'execution_overview',
      'architectural_observations', 'recommended_actions',
      'suggested_tests_new', 'complexity', 'scorecard_new',
      'verdict', 'limitations', 'debug_trace',
    ];
