...
function HomeContent() {
  ...
  const buildSnippetFromPayload = useCallback((
    ...
    return {
      ...
      card_image_url: null,
      code_walkthrough: (payload.code_walkthrough as CodeWalkthroughItem[]) || null,
      what_works_well: (payload.what_works_well as string[]) || null,
      bugs_and_risky_cases: (payload.bugs_and_risky_cases as BugAndRiskyCase[]) || null,
      edge_cases: (payload.edge_cases as EdgeCase[]) || null,
      ...
      recommended_improvements: (payload.recommended_improvements as RecommendedImprovement[]) || null,
      improved_code: (payload.improved_code as string) || null,
      suggested_tests: (payload.suggested_tests as SuggestedTest[]) || null,
      scorecard: (payload.scorecard as ScorecardLegacy) || null,
      final_verdict_summary: (payload.final_verdict_summary as string) || null,
      final_verdict_approved: (payload.final_verdict_approved as boolean) || null,
      final_verdict_next_steps: (payload.final_verdict_next_steps as string) || null,
      line_explanations: null,
      generated_prompt: null,
      findings: (payload.findings as AuditFinding[]) || null,
      execution_overview: (payload.execution_overview as AdvancedAuditResult['executionOverview']) || null,
      architectural_observations: (payload.architectural_observations as AdvancedAuditResult['architecturalObservations']) || null,
      recommended_actions: (payload.recommended_actions as AdvancedAuditResult['recommendedActions']) || null,
      suggested_tests_new: (payload.suggested_tests_new as AdvancedAuditResult['suggestedTests']) || null,
      complexity: (payload.complexity as AdvancedAuditResult['complexity']) || null,
      scorecard_new: (payload.scorecard_new as AuditScorecard) || null,
      verdict: (payload.verdict as AdvancedAuditResult['verdict']) || null,
