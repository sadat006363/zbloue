...
export default async function SnippetPage({ params, searchParams }: PageProps) {
  ...
  try {
    ...
    const modeBadge = {
      simple: { label: '⚡ Simple Analysis', color: 'bg-blue-100 text-blue-700 border-blue-200' },
      medium: { label: '📊 Medium Analysis', color: 'bg-purple-100 text-purple-700 border-purple-200' },
      advanced: { label: '🔬 Advanced Analysis', color: 'bg-green-100 text-green-700 border-green-200' },
    ...
    try {
      ...
      highlightedHtml = `<pre class="text-[#1a1a2e] p-4">${safeString(snippet.raw_code)}</pre>`;
    }
    ...
    return (
      // ============================================================
      // 🔥 پس‌زمینه کاملاً سفید و تمیز (مثل تب All Outputs)
      // ============================================================
      <main className="min-h-screen bg-white text-[#1a1a2e] p-4 md:p-6 flex flex-col items-center">
        <div className="w-full max-w-[1400px] mx-auto space-y-6">

          {/* ===== HEADER ===== */}
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white p-4 rounded-xl border border-[#d0d0d8] shadow-sm">
            <div className="flex items-center gap-4">
              <Link href="/" className="text-[#4a86f7] hover:text-[#3b6fd4] transition-colors text-sm font-medium flex items-center gap-1">
                ← بازگشت
              </Link>
              <span className="text-[#a0a0b0]">|</span>
              <div className="flex items-center gap-2">
                <h1 className="text-xl md:text-2xl font-bold text-[#1a1a2e] tracking-tight truncate max-w-[300px] md:max-w-[500px]">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <a href={shareUrls.linkedin} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-[#0a66c2]/10 hover:bg-[#0a66c2]/20 transition" title="LinkedIn">
              ...
              <a href={shareUrls.twitter} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-[#1DA1F2]/10 hover:bg-[#1DA1F2]/20 transition" title="Twitter">
              ...
              <a href={shareUrls.whatsapp} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-[#25D366]/10 hover:bg-[#25D366]/20 transition" title="WhatsApp">
              ...
              <a href={shareUrls.telegram} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-[#0088cc]/10 hover:bg-[#0088cc]/20 transition" title="Telegram">
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm text-[#4a4a6a] bg-[#f8f9fa] p-3 rounded-xl border border-[#d0d0d8]">
            <span className="bg-[#e8e8f0] px-2.5 py-0.5 rounded-full text-[#4a4a6a] font-semibold">
          ...
          {/* ===== کد منبع ===== */}
          <div className="bg-[#f8f9fa] rounded-xl border border-[#d0d0d8] overflow-hidden shadow-sm">
            <div className="flex items-center justify-between px-4 py-2 bg-white border-b border-[#e8e8f0]">
              <span className="text-sm font-semibold text-[#4a86f7]">💻 کد منبع</span>
            </div>
            <div className="bg-[#fafbfc] p-4 overflow-x-auto max-h-[600px] font-mono text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-xl border border-[#d0d0d8] shadow-sm">
              <h3 className="text-lg font-semibold text-[#4a86f7] flex items-center gap-2">💡 Key Concept</h3>
              <p className="text-[#4a4a6a] text-sm leading-relaxed mt-1">{safeString(snippet.key_concept || 'No key concept provided.')}</p>
            </div>
            <div className="bg-white p-4 rounded-xl border border-[#d0d0d8] shadow-sm">
              <h3 className="text-lg font-semibold text-[#4a86f7] flex items-center gap-2">🔍 What This Code Does</h3>
              <p className="text-[#4a4a6a] text-sm leading-relaxed mt-1">{safeString(snippet.what_this_code_does || 'No description available.')}</p>
            </div>
          </div>
          ...
          {(isMedium || isAdvanced) && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-xl border border-[#d0d0d8] shadow-sm">
                <h3 className="text-lg font-semibold text-[#e53935] flex items-center gap-2">🐛 Debug Analysis</h3>
                <p className="text-[#4a4a6a] text-sm leading-relaxed mt-1">
                  {isAdvanced
              ...
              <div className="bg-white p-4 rounded-xl border border-[#d0d0d8] shadow-sm">
                <h3 className="text-lg font-semibold text-[#43a047] flex items-center gap-2">⚡ Optimization</h3>
                <p className="text-[#4a4a6a] text-sm leading-relaxed mt-1">
                  {isAdvanced
          ...
          {isAdvanced && hasAdvancedAnalysis && (
            <div className="bg-white p-6 rounded-xl border border-[#d0d0d8] shadow-sm space-y-6">
              <h2 className="text-2xl font-bold text-[#1a1a2e]">📊 Advanced Analysis</h2>
              <div className="space-y-4">
                {snippet.code_walkthrough && snippet.code_walkthrough.length > 0 && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#4a86f7]">🧩 Code Walkthrough</h3>
                    <div className="space-y-2 mt-2">
                      {snippet.code_walkthrough.map((item: CodeWalkthroughItem, idx: number) => (
                        <div key={idx} className="border-b border-[#e8e8f0] pb-2 last:border-0">
                          <p className="font-medium text-[#1a1a2e]">{item.section}</p>
                          <p className="text-[#4a4a6a] text-sm">{item.explanation}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {snippet.what_works_well && snippet.what_works_well.length > 0 && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#43a047]">✅ What Works Well</h3>
                    <ul className="list-disc list-inside text-[#4a4a6a] text-sm mt-2">
                ...
                {snippet.bugs_and_risky_cases && snippet.bugs_and_risky_cases.length > 0 && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#e53935]">🐛 Bugs and Risky Cases</h3>
                    <div className="space-y-2 mt-2">
                      {snippet.bugs_and_risky_cases.map((item: BugAndRiskyCase, idx: number) => (
                        <div key={idx} className="border-b border-[#e8e8f0] pb-2 last:border-0">
                          <p className="font-medium text-[#1a1a2e]">{item.issue}</p>
                          <p className="text-[#4a4a6a] text-sm">Impact: {item.impact}</p>
                          {item.example && <p className="text-[#4a4a6a] text-xs">Example: {item.example}</p>}
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {snippet.edge_cases && snippet.edge_cases.length > 0 && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#4a86f7]">🧪 Edge Cases</h3>
                    <div className="space-y-2 mt-2">
                      {snippet.edge_cases.map((item: EdgeCase, idx: number) => (
                        <div key={idx} className="border-b border-[#e8e8f0] pb-2 last:border-0">
                          <p className="font-medium text-[#1a1a2e]">{item.case}</p>
                          <p className="text-[#4a4a6a] text-sm">Current: {item.currentBehavior}</p>
                          <p className="text-[#4a4a6a] text-sm">Expected: {item.expectedBehavior}</p>
                          <p className="text-[#4a4a6a] text-xs">Risk: {item.risk}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {snippet.performance_analysis && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#4a86f7]">⚡ Performance Analysis</h3>
                    <div className="mt-2 text-[#4a4a6a] text-sm">
                ...
                {snippet.security_analysis && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#e53935]">🔒 Security Analysis</h3>
                    <div className="mt-2 text-[#4a4a6a] text-sm">
                ...
                {snippet.production_readiness && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#4a86f7]">🛡️ Production Readiness</h3>
                    <div className="mt-2 text-[#4a4a6a] text-sm">
                ...
                {snippet.recommended_improvements && snippet.recommended_improvements.length > 0 && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#43a047]">🔧 Recommended Improvements</h3>
                    <div className="space-y-2 mt-2">
                      {snippet.recommended_improvements.map((item: RecommendedImprovement, idx: number) => (
                        <div key={idx} className="border-b border-[#e8e8f0] pb-2 last:border-0">
                          <p className="font-medium text-[#1a1a2e]">[{item.priority}] {item.improvement}</p>
                          <p className="text-[#4a4a6a] text-sm">Reason: {item.reason}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {snippet.scorecard && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#4a86f7]">📊 Scorecard</h3>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mt-2">
                      {Object.entries(snippet.scorecard).map(([key, value]) => (
                        <div key={key} className="bg-white p-2 rounded-md text-center border border-[#d0d0d8]">
                ...
                {snippet.final_verdict_summary && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#4a86f7]">🏁 Final Verdict</h3>
                    <p className="mt-2 text-[#4a4a6a]"><strong>Summary:</strong> {snippet.final_verdict_summary}</p>
                    <p className="text-[#4a4a6a]"><strong>Approved:</strong> {snippet.final_verdict_approved ? '✅ Yes' : '❌ No'}</p>
                    {snippet.final_verdict_next_steps && <p className="text-[#4a4a6a]"><strong>Next Steps:</strong> {snippet.final_verdict_next_steps}</p>}
                  </div>
                )}
                {snippet.improved_code && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#4a86f7]">✨ Improved Code</h3>
                    <pre className="text-[#1a1a2e] text-sm whitespace-pre-wrap overflow-auto max-h-[400px] mt-2 bg-[#fafbfc] p-3 rounded border border-[#d0d0d8]">{snippet.improved_code}</pre>
                  </div>
                )}
                {snippet.suggested_tests && snippet.suggested_tests.length > 0 && (
                  <div className="bg-[#f8f9fa] p-4 rounded-lg border border-[#d0d0d8]">
                    <h3 className="text-lg font-semibold text-[#4a86f7]">🧪 Suggested Tests</h3>
                    <div className="space-y-2 mt-2">
                      {snippet.suggested_tests.map((test: SuggestedTest, idx: number) => (
                        <div key={idx} className="border-b border-[#e8e8f0] pb-2 last:border-0">
                          <p className="font-medium text-[#1a1a2e]">{test.name}</p>
                          <p className="text-[#4a4a6a] text-sm">Input: {test.input}</p>
                          <p className="text-[#4a4a6a] text-sm">Expected: {test.expectedOutput}</p>
                          <p className="text-[#4a4a6a] text-xs">Type: {test.type}</p>
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          {isAdvanced && hasLineExplanations && (
            <div className="bg-white p-6 rounded-xl border border-[#d0d0d8] shadow-sm">
              <h2 className="text-2xl font-bold text-[#1a1a2e] mb-4">📝 Line-by-Line Explanations</h2>
              <div className="space-y-2 max-h-[500px] overflow-y-auto">
                {snippet.line_explanations.map((item: LineExplanation, idx: number) => (
                  <div key={idx} className="border-b border-[#e8e8f0] pb-2 last:border-0">
                    <p className="font-mono text-sm text-[#1a1a2e]">Line {item.lineNumber}: {item.code}</p>
                    <p className="text-[#4a4a6a] text-sm">💡 {item.explanation}</p>
                  </div>
                ))}
              </div>
          ...
          {isAdvanced && hasGeneratedPrompt && (
            <div className="bg-white p-6 rounded-xl border border-[#d0d0d8] shadow-sm">
              <h2 className="text-2xl font-bold text-[#1a1a2e] mb-4">📝 Generated Prompt</h2>
              <div className="bg-[#fafbfc] p-4 rounded-lg border border-[#d0d0d8] text-[#1a1a2e] text-sm whitespace-pre-wrap max-h-[400px] overflow-y-auto">
          ...
          {/* ===== LinkedIn Post ===== */}
          <div className="bg-white p-6 rounded-xl border border-[#d0d0d8] shadow-sm">
            <h3 className="text-lg font-semibold text-[#e67e22] flex items-center gap-2">💼 LinkedIn Post</h3>
            <p className="mt-2 text-[#4a4a6a] text-sm whitespace-pre-wrap leading-relaxed">{safeString(snippet.linkedin_post || 'No LinkedIn post available.')}</p>
          </div>

          {/* ===== فوتر ===== */}
          <div className="text-center text-xs text-[#a0a0b0] py-4 border-t border-[#e8e8f0]">
            <p>✨ Built with <a href={appUrl} target="_blank" rel="noopener noreferrer" className="text-[#4a86f7] hover:underline">Zbloue</a></p>
          </div>
