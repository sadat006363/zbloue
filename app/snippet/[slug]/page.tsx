    ...
    return (
      <main className="min-h-screen bg-gray-50 text-gray-800 p-4 md:p-6 flex flex-col items-center">
        <div className="w-full max-w-[1400px] mx-auto space-y-6">
          ...
          {/* ===== HEADER ===== */}
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white shadow-sm p-4 rounded-2xl border border-gray-200">
            <div className="flex items-center gap-4">
              <Link href="/" className="text-blue-600 hover:text-blue-800 transition-colors text-sm font-medium flex items-center gap-1">
                ← Back
              </Link>
              <span className="text-gray-400">|</span>
              <div className="flex items-center gap-2">
                <h1 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight truncate max-w-[300px] md:max-w-[500px]">
          ...
          {/* ===== User info and date ===== */}
          <div className="flex flex-wrap items-center gap-3 text-sm text-gray-600 bg-white shadow-sm p-3 rounded-xl border border-gray-200">
            <span className="bg-gray-100 px-2.5 py-0.5 rounded-full text-gray-700 font-semibold">
